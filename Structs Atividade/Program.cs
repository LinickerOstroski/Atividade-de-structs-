...
class Program
{
    ...
    static void removerEletro(List<Eletro> lista, string nomeBusca)
    {
        int qtd = lista.Count();
        for (int i = 0; i < qtd; i++)
        {
    ...
    static void buscarNome(List<Eletro> lista, string NomeProcurado)
    {
        int qtd = lista.Count();
        for (int i = 0; i < qtd; i++)
        {
    ...
    static void calcularCustoEletro(List<Eletro> lista, string nomeBusca)
    {
        ...
        foreach (Eletro eletro in lista)
        {
            ...
            {
                consumoDia = eletro.potencia * eletro.tempoMedio;
    ...
    static void consumo(List<Eletro> lista)
    {
        int qtd = lista.Count();
        ...
        //Console.WriteLine("O Consumo da casa é: " + consumo);
    ...
    static void comparar(List<Eletro> lista)
    {
        ...
        foreach (Eletro eletro in lista)
        {
            if (eletro.potencia > p)
            {
                Console.WriteLine($"O eletrodoméstico {eletro.nome} maior que {p}");
                Console.WriteLine("Potencia: " + eletro.potencia);
                Console.WriteLine("TempoMedio (horas):" + eletro.tempoMedio);
            }
    ...
    static void cadastrar(List<Eletro> lista)
    {

        Eletro cadastro = new Eletro();
        double gasto;
    ...
    static void listar(List<Eletro> lista)
    {
        int qtd = lista.Count();
        Console.Clear();
